...
class AST2500Machine(AspeedTest):
    ...
    ASSET_SDK_V908_AST2500_515 = Asset(
        'https://github.com/AspeedTech-BMC/openbmc/releases/download/v09.08/ast2500-default-515-obmc.tar.gz',
        '2947fdb980db02f3806a0d03f0357b11601b61ae66ef4bdba1c1398f776b3970')

    def test_arm_ast2500_evb_sdk_515(self):
        self.set_machine('ast2500-evb')

        self.archive_extract(self.ASSET_SDK_V908_AST2500_515)
