...
class AST2500Machine(AspeedTest):
    ...
    ASSET_SDK_V905_AST2500_515 = Asset(
        'https://github.com/AspeedTech-BMC/openbmc/releases/download/v09.05/ast2500-default-515-obmc.tar.gz',
        '70fe5fb511b2bbc561133eaa5ea82b7098dd4c64c2fcaf71c162d0f30aa85b3b')

    def test_arm_ast2500_evb_sdk_515(self):
        self.set_machine('ast2500-evb')

        self.archive_extract(self.ASSET_SDK_V905_AST2500_515)
